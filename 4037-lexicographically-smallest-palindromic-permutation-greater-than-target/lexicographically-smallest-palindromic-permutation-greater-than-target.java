class Solution {
    ...
    public String lexPalindromicPermutation(String s, String target) {
        ...
        for(int i=0;i<n/2;i++){
            ...
            if(prefix.charAt(i)>target.charAt(i)) {
                ...
                return left.toString()+ oddChar+
                          new StringBuilder(left).reverse().toString() ;
            }
        }

        String ans=prefix.toString()+oddChar+
    ...
    private boolean check(String prefix, char c, int[] cnt,
        ...
        String palindrome=left.toString()+oddChar+
                          new StringBuilder(left).reverse().toString();
